		...
		<div class="container">
			<form name="frm" id="frm" action="./movieInfoWrite" method="post" enctype="multipart/form-data">
				<table style="width: 1000px;">
					<tr>
						<td class="write-tdName"><span class="titleSpan">KIND</span></td>
						<td class="write-tdWrite" colspan="2" class="genreTD">
					...
					<tr>
						<td class="write-tdName"><span class="titleSpan">GENRE</span></td>
						<td class="write-tdWrite" colspan="2">
							<!-- 작업중... -->
							<table>
								<tr>
								<td class="td_radio"><label class="checkbox-inline">
					...
					<tr>
						...
						<td class="write-tdWrite" colspan="2"><input class="form-control" type="text" name="director" id="director"></td>
					</tr>
					<tr>
						<td class="write-tdName"><span class="titleSpan">ACTOR</span></td>
						<td class="write-tdWrite" colspan="2"><input class="form-control" type="text" name="actor" id="actor"></td>
					</tr>
					<tr>
						<td class="write-tdName"><span class="titleSpan">YEAR</span></td>
						<td class="write-tdWrite" colspan="2"><input class="form-control" type="number" name="year" id="year" min="1900" max="2050"></td>
					</tr>
					<tr>
						<td class="write-tdName"><span class="titleSpan">NATION</span></td>
						<td class="write-tdWrite" colspan="2"><input class="form-control" type="text" name="nation" id="nation"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="write-tdWrite" colspan="2"><input class="form-control" type="date" name="pub_date" id="pub_date"></td>
					</tr>
					<tr>
						<td class="write-tdName"><span class="titleSpan">WATCHING_RATE</span></td>
						<td class="write-tdWrite" colspan="2">
					...
					<tr>
						<td class="write-tdName"><span class="titleSpan">PLAY_TIME</span></td>
						<td class="write-tdWrite" colspan="2"><input class="form-control" type="number" name="play_time" id="play_time"></td>
					</tr>
					<tr>
						<td class="write-tdName"><span class="titleSpan">STORY</span></td>
						<td class="write-tdWrite" colspan="2"><textarea style="height: 100px;" class="form-control" name="story" id="story"></textarea></td>
					</tr>
					<tr>
					...
					<tr>
						<td class="lastTD" colspan="3">
							<input class="button btn btn-primary" type="button" value="글쓰기" id="submitBtn">				
						</td>
					</tr>
				</table>
			</form>
